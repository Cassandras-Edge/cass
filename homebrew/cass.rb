class Cass < Formula
  ...
  license "Proprietary"
  version "0.8.4" # bump-homebrew: VERSION

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/Cassandras-Edge/cass/releases/download/v#{version}/cass-darwin-arm64"
      sha256 "0b3cd9709c6a8b40a68d219a29363539d7c8b537f40d46eefeccf377a9fbcd5a" # bump-homebrew: SHA_DARWIN_ARM64
      ...
      sha256 "c00f0d8cfc2108e9fca4e8fc8e72b4b269233cce16cfdad354a42dee488b3097" # bump-homebrew: SHA_DARWIN_AMD64
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "874666fc8bdc63d3162a619992aeaaca7c21f7cb2958cdf3766937344fc806f6" # bump-homebrew: SHA_LINUX_ARM64
      ...
      sha256 "b8cd1ec1e82ae1c8a077e2cf5f968f257600b35d5d33b6760d82066d41d13185" # bump-homebrew: SHA_LINUX_AMD64

class Cass < Formula
  ...
  license "Proprietary"
  version "0.8.3" # bump-homebrew: VERSION

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/Cassandras-Edge/cass/releases/download/v#{version}/cass-darwin-arm64"
      sha256 "b1592d6463c6dfea7be3d95b900eee4246b329d7b4307338152a93d5c4872b9f" # bump-homebrew: SHA_DARWIN_ARM64
      ...
      sha256 "c5b81288107a3031789f308c445aa02506a4455891622cd6bf853c14f5e34a04" # bump-homebrew: SHA_DARWIN_AMD64
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "8253ea60c1b5de274c5f1221ba8c4873115438317ffccb2dd8f334e818210151" # bump-homebrew: SHA_LINUX_ARM64
      ...
      sha256 "9c7135a295d1cd1c7d89dc3a39619ce9cd4e6319487178d3cbedcf6b9af8e30c" # bump-homebrew: SHA_LINUX_AMD64

class Cass < Formula
  ...
  license "Proprietary"
  version "0.8.2" # bump-homebrew: VERSION

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/Cassandras-Edge/cass/releases/download/v#{version}/cass-darwin-arm64"
      sha256 "f64b72538f87cf24f42d9109e40b3b41827564ddc5cd69dae57626026703a88b" # bump-homebrew: SHA_DARWIN_ARM64
      ...
      sha256 "95f52c5ac8dfeae17dce01855d47fe8ef96bc847d196f1485aca1159af67dc50" # bump-homebrew: SHA_DARWIN_AMD64
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "885ade5329a5fe1e7ef795b9325f02e3c8e3fee5f5312b91de16f24bdc59379e" # bump-homebrew: SHA_LINUX_ARM64
      ...
      sha256 "c702e64c1779f8f70d5ef9b618336602671839f15bca10c11ddf35bdab4c1ed9" # bump-homebrew: SHA_LINUX_AMD64

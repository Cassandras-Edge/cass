class Cass < Formula
  ...
  license "Proprietary"
  version "0.9.1" # bump-homebrew: VERSION

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/Cassandras-Edge/cass/releases/download/v#{version}/cass-darwin-arm64"
      sha256 "4f35808daef6882cbb57a3764452855aa4191625a227d24acfc8330a385e2fd1" # bump-homebrew: SHA_DARWIN_ARM64
      ...
      sha256 "d36384669393a31aa463e8ed63c0a48abc651c73c790bd47ebdb63fb050df9ec" # bump-homebrew: SHA_DARWIN_AMD64
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "b15a91f025dd5713358334b95de979af6fc6884a78668be5788effdec5ec9d43" # bump-homebrew: SHA_LINUX_ARM64
      ...
      sha256 "7d019b3f02d031819bb173a05a58805cc1f1376e33a3175401c68913291ffb70" # bump-homebrew: SHA_LINUX_AMD64
